...
export default function Support() {
    ...
    return(
        ...
        initial='hidden'
        whileInView='visible'
         className='min-h-1/5 w-75 mx-auto py-20  mb-10'>
            <div className='flex justify-center relative h-[100px]  text-center'>
                    <div className='inline-block absolute z-10'>
                        <div>
                            <h3 className='font-[Righteous] text-40'>Support</h3>
                            <p className='text-[#797B89] text-18 md:w-[400px] mt-3  font-[circularstd] '>This is a big one and i consider it one of the most important things for a designer to get right</p>
                        </div>
                    </div>
                    <div className='absolute w-120 h-120  right-[35%] -top-10 -z-0 ' >
                        <Image src={two} alt='two' layout="fill" className='opacity-30'/>
                    </div>
            </div>
            <div className=' mt-20 border-white border-2 '>
            <div className='mt-[53px] grid md:grid-cols-3 gap-20 grid-cols-1 md:text-left text-center'>
                    <motion.div
                        initial={{ opacity: 0, y: 70 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        className=' font-[circularstd] block'>
                            ...
                            <div className='py-6'>
                                <h4 className='font-medium text-18 leading-5 mb-2 ' >Are you a supplier?</h4>
                        ...
                        <div className='flex md:justify-start justify-center'>
                            ...
                            <div className='py-6'>
                                <h4 className='font-medium text-18 leading-5 mb-2' >Do you have a property?</h4>
                                <p className='text-sm text-[#718096]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus am, purus sit amet luctus am, purus sit amet luctus</p>
                            </div>
                            <Button backgroundColor="#FD4C5C" color="#fff" borderRadius="50px" paddingBottom="12px" paddingTop="12px"  paddingRight="55px" paddingLeft="55px" fontSize="14px" >
                                Apply
                        ...
                        className='font-[circularstd]'>
                            ...
                            <div className='py-6'>
                                <h4 className='font-medium text-18 leading-5 mb-2' >Investors</h4>
                                <p className='text-sm text-[#718096]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus am, purus sit amet luctus am, purus sit amet luctus</p>
                            </div>
                            <Button backgroundColor="#FD4C5C" color="#fff" borderRadius="50px" paddingBottom="12px" paddingTop="12px"  paddingRight="55px" paddingLeft="55px" fontSize="14px" >
                                Apply
