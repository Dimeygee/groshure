                ...
                <motion.div 
                        ...
                        className='bg-white w-[95%] md:w-[50%] xl:w-[35%] rounded-[25px] my-3 relative mx-auto'>
                            <div className='flex px-5 py-3 items-center justify-between'>
                                <div></div>
                                <h3 className='xl:text-18 4xl:text-[54px] 2xl:text-25 3xl:text-30 font-[circularstd] font-medium'>Apply as an Investor</h3>
                            ...
                            <div className='pt-4 pb-10 px-7'>
                                ...
                                <fieldset className='border-2 border-[#E8E9ED] px-4 py-1 text-sm 4xl:px-10 text-[#212B08] rounded-[12px] my-4 4xl:text-42 3xl:text-24 2xl:text-[19px] 4xl:py-5 4xl:rounded-[35px] 4xl:mb-10 '>
                                    ...
                                    <input type='text' placeholder='Enter name' className=' p-0 inline-block w-100p text-base border-none outline-none 4xl:text-42 3xl:text-24' value={storename} onChange={(e) => setStoreName(e.target.value)}/>
                                    </fieldset>
                                    <fieldset className='border-2 border-[#E8E9ED] px-4 py-1 text-sm 4xl:px-10 text-[#212B08] rounded-[12px] my-4 4xl:text-42 3xl:text-24 2xl:text-[19px] 4xl:py-5 4xl:rounded-[35px] 4xl:mb-10 '>
                                        <legend>Email</legend>
                                    ...
                                    <fieldset className='border-2 border-[#E8E9ED] px-4 py-1 text-sm 4xl:px-10 text-[#212B08] rounded-[12px] my-4 4xl:text-42 3xl:text-24 2xl:text-[19px] 4xl:py-5 4xl:rounded-[35px] 4xl:mb-10 '>
                                        ...
                                        <input type='text' placeholder='Enter phone number' className=' p-0 inline-block w-100p text-base border-none outline-none 4xl:text-42 3xl:text-24' value={phoneNumber} onChange={(e)  => setPhoneNumber(e.target.value)} />
                                    </fieldset>
                                    <fieldset className='border-2 border-[#E8E9ED] px-4 py-1 text-sm 4xl:px-10 text-[#212B08] rounded-[12px] my-4 4xl:text-42 3xl:text-24 2xl:text-[19px] 4xl:py-5 4xl:rounded-[35px] 4xl:mb-20 2xl:mb-12 mb-10'>
                                            ...
                                            <input type='text'  className=' p-0 inline-block w-100p text-base border-none outline-none 4xl:text-42 3xl:text-24' value={additionInfo} onChange={(e)  => setAdditionInfo(e.target.value)}/>
                                    </fieldset>
