...
export default function ComingSoon(){
    ...
    return(
        <div className='min-h-1/5 md:min-h-1/3  xl:min-h-1/3 md:flex items-center flex-row md:my-0 mt-[100px] md:mt-0 md:mb-0  mb-[150px] 2xl:min-h-[120vh] 4xl:min-h-[70vh] '>
            <div className='mx-auto min-h-1/4 md:min-h-1/3 xl:min-h-1/3  md:flex 4xl:min-h-1/3 w-[90%] 4xl:w-[80%] md:w-[90%] items-center '>
                <motion.div 
                    variants={left}
                    custom={1}
                    initial="hidden"
                ...
                <motion.div 
                   ...
                   className='md:w-[45%] xl:w-[50%] lg:w-[40%] flex justify-center flex-col md:pr-6  text-center md:text-left'>
                    <div className='md:w-[100%] xl:w-[480px]  md:px-0 lg:pr-8 4xl:px-0 4xl:w-[80%] 3xl:w-85 2xl:w-85'>
                        ...
                        <form method="POST" onSubmit={handleSubmit}>
                            ...
                            <div className='md:w-[50%] lg:w-[55%] xl:w-[65%]'>
                                <input type="text" placeholder="Enter email address" className='wait_input inline-block  md:py-2 lg:py-2 pl-7 py-1 rounded-l-[50px] 3xl:rounded-l-[100px] 4xl:rounded-l-[150px] w-[100%] 4xl:py-8 3xl:py-3' />
                            </div>
